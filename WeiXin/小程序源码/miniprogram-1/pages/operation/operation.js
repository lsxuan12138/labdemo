...
Page({
  ...
  data: {
      ...
      areaName:'',
      priority:'',
      addUrl:'http://localhost:8081/demo/superadmin/addArea',
      modifyUrl:'http://localhost:8081/demo/superadmin/updateArea'
  },
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://localhost:8081/demo/superadmin/findById',
